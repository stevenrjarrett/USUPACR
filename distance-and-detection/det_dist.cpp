...
//        cv::cvtColor(rgbimg, continuousRGBA, CV_BGR2RGBA, 4);
        ...
        for(int i=0; i<color_numElements; i++)
        {
            int rgb_ind = i*3;
            int rgba_ind = i*4;
            colorData_flt_CPU[rgba_ind+1] = (float)colorData[rgb_ind+0];
            colorData_flt_CPU[rgba_ind+2] = (float)colorData[rgb_ind+1];
            colorData_flt_CPU[rgba_ind+3] = (float)colorData[rgb_ind+2];
            colorData_flt_CPU[rgba_ind+0] = 255.0;
        }
